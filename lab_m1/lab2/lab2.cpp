...
void Lab2::Init()
{
    ...
    // by definition!
    {
       /* vector<VertexFormat> vertices_t
        {
            VertexFormat(glm::vec3(2, 1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2.5f, 1,  2), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2.5f, 3,  1.5f), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        };
        ...
        {
            //0,1,2
            VertexFormat(glm::vec3(2, 1,  1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 1,  1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 1,  1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),

            //3,4,5
            VertexFormat(glm::vec3(3, 1,  1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 1,  1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),

            //6,7,8
            VertexFormat(glm::vec3(2.5f, 1,  2), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2.5f, 1,  2), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2.5f, 1,  2), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            
            //9,10,11
            VertexFormat(glm::vec3(2.5f, 3,  1.5f), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2.5f, 3,  1.5f), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2.5f, 3,  1.5f), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6))
        ...
        CreateMesh("tetrahedron", vertices_t, indices_t);
    }
    ...
    // opposing vertex orientations.
    {
        ...
        CreateMesh("square", vertices_s, indices_s);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(0.25f));
